@extends('backend.app', ['title' => 'Company Section'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">CMS : Cleaning Section</h1>
                </div>
                <div class="ms-auto pageheader-btn">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">CMS</li>
                        <li class="breadcrumb-item">ABOut</li>
                        <li class="breadcrumb-item active" aria-current="page">Cleaning Section</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.cms.about.cleaning.content') }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
