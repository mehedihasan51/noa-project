@extends('backend.app', ['title' => 'Hire Banner'])
    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <div>
                    <h1 class="page-title">CMS : Hire Banner</h1>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.cms.hire.banner.content') }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
