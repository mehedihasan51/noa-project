        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.service.index') }}" class="slide-item">Service Section</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.company.index') }}" class="slide-item">Our Company</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.mission.index') }}" class="slide-item">Our Mission</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.we.index') }}" class="slide-item">We are</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.cleaning.index') }}" class="slide-item">Car Cleaning</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.office.index') }}" class="slide-item">Office Cleaning</a></li>
                    </ul>
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.about.interior.index') }}" class="slide-item">Interior Cleaning</a></li>
                    </ul>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Contact Page</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.contact.banner.index') }}" class="slide-item">Banner Section</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Blog Page</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.blog.banner.index') }}" class="slide-item">Banner Section</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Hire Page</span><i class="angle fa fa-angle-right"></i>
                    </a>

                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.cms.hire.banner.index') }}" class="slide-item">Banner Section</a></li>
                        <li><a href="{{ route('admin.cms.hire.committed.index') }}" class="slide-item">Committed Section</a></li>
                    </ul>
                </li>
            </ul>
            <br>
